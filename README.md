...
- The cross-world panel reads the 100 cheapest listings per scope. On a heavily stocked item the
  units-available figure is therefore a floor, and the panel says so when it hits that wall.
